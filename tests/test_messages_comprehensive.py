...
class TestMessageEncryption:
    ...
    def test_encrypt_message_content(self):
        ...
        encrypted = encrypt_field(original, context="messages")
    ...
    def test_decrypt_message_content(self):
        ...
        encrypted = encrypt_field(original, context="messages")
        decrypted = decrypt_field(encrypted, context="messages")
    ...
    def test_encryption_uniqueness(self):
        ...
        encrypted1 = encrypt_field(content, context="messages")
        encrypted2 = encrypt_field(content, context="messages")
...
class TestMessageCRUD:
    ...
    def test_send_urgent_message(self, client: TestClient, auth_headers: dict):
...
class TestMessageThreads:
    ...
    def test_create_conversation_thread(self, client: TestClient, auth_headers: dict):
    ...
    def test_get_conversation_with_user(self, client: TestClient, auth_headers: dict):
...
class TestMessageReadStatus:
    ...
    def test_read_at_timestamp_set(self, client: TestClient, auth_headers: dict, db_session: Session):
        ...
        message = Message(
            ...
            receiver_id=2,
            subject="Test",
            encrypted_content=encrypt_field("Test content", context="messages"),
...
class TestSoftDelete:
    ...
    def test_soft_delete_by_sender(self, client: TestClient, auth_headers: dict):
    ...
    def test_soft_delete_does_not_affect_receiver(self, db_session: Session):
        ...
        message = Message(
            ...
            receiver_id=2,
            subject="Test",
            encrypted_content=encrypt_field("Content", context="messages"),
            status=MessageStatus.DELIVERED,
...
class TestMessageSecurity:
    ...
    def test_message_content_encrypted_in_db(self, db_session: Session):
        ...
        encrypted = encrypt_field(original_content, context="messages")
...
class TestMessagePerformance:
    ...
    def test_bulk_message_retrieval(self, client: TestClient, auth_headers: dict):
