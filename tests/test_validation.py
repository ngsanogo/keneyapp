...
class TestSQLInjectionPrevention:
    ...
    def test_sql_patterns_detected(self):
        ...
        for pattern in sql_patterns:
            ...
            matched = any(regex.search(pattern) for regex in middleware.sql_regex)
...
class TestXSSPrevention:
    ...
    def test_xss_patterns_detected(self):
        ...
        for pattern in xss_patterns:
            matched = any(regex.search(pattern) for regex in middleware.xss_regex)
...
class TestPathTraversalPrevention:
    ...
    def test_path_traversal_detected(self):
        ...
        for pattern in traversal_patterns:
            matched = any(regex.search(pattern) for regex in middleware.path_regex)
